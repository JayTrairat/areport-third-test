...
def main():
    # with open('assets/group_1.txt', 'r', encoding='utf8') as source:
    #     contents_1 = [content.strip() for content in source.readlines()]
    #     contents_1.sort(reverse=True)
    #     group_1 = contents_1[:10]
